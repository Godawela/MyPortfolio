    ...
    <div className="border-b border-neutral-900 pb-4">
        ...
        <div className="flex flex-wrap">
            ...
            className="w-full lg:w-1/2">
                    ...
                    including React, Node.js, MySQL, and MongoDB. My journey 
                    in web development began with a deep curiosity about how 
                    things work, evolving into a career where I continuously 
                    strive to learn and adapt to new challenges. I thrive in 
                    collaborative environments and enjoy solving complex problems 
                    to deliver high-quality solutions. Outside of coding, I stay 
                    active, explore new technologies, and contribute to open-source 
                    projects.</p>
                    </div>
            </motion.div>
    </div>
